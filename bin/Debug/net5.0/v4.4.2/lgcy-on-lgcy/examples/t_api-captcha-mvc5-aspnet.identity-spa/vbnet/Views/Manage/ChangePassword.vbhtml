...
@Using Html.BeginForm("ChangePassword", "Manage", FormMethod.Post, New With {.class = "form-horizontal", .role = "form"})
    ...
    @<text>
        ...
        <div class="col-md-6" id="form-container">
            ...
            @Code Dim changePasswordCaptcha As MvcCaptcha = CaptchaHelper.GetExampleCaptcha("ChangePasswordCaptcha")
...
<div class="col-md-6" id="notes">
    <div class="note">
        ...
        <p>Starting with the default ASP.NET MVC 5.2.3 Web Application project template, the example includes all code required to add CAPTCHA validation to the <code>Manage</code> controller <code>ChangePassword</code> action.</p>
    </div>
