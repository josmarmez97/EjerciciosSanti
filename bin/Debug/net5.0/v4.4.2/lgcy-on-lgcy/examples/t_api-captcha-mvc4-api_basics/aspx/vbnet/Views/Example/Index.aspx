    ...
    <div class="column">
        <div id="notes" class="column">
            <div class="note">
                ...
                <p>ASP.NET MVC View code displaying CAPTCHA protection can be found in <code>Views/Example/Index.aspx</code>, and the ASP.NET MVC Controller code checking user input is in <code>Controllers/ExampleController.vb</code>.</p>
            </div>
