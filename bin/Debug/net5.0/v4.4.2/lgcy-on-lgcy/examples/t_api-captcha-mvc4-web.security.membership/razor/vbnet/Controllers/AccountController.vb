...
Public Class AccountController
    ...
    <CaptchaValidationActionFilter("CaptchaCode", "LoginCaptcha", "Your input doesn't match displayed characters.")> _
    ...
    <AllowAnonymous()> _
    <ValidateAntiForgeryToken()> _
    <CaptchaValidationActionFilter("CaptchaCode", "RegistrationCaptcha", "Your input doesn't match displayed characters.")> _
    Public Function Register(ByVal model As RegisterModel) As ActionResult
        If ModelState.IsValid Then
            ...
            Try
                ...
                ' Reset CAPTCHA status after successful account registration.
