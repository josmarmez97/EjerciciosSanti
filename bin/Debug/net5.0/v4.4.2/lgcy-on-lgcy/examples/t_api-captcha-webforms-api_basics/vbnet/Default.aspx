<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Default.aspx.vb" Inherits="WebFormsBasicCaptchaExampleVBNet._Default" %>
    ...
    <div class="column">
        <div class="column">
             <div class="note">
                ...
                <p>ASP.NET form declarations displaying CAPTCHA protection can be found in <code>Default.aspx</code>, and the code-behind code checking user input is in <code>Default.aspx.vb</code>.</p>
            </div>
        </div>
