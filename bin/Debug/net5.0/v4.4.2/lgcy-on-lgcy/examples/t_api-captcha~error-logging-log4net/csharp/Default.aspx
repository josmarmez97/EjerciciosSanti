<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="CaptchaTroubleshootingExampleCSharp.Default" %>
    ...
    <div class="column">
        <div class="column">
             <div class="note">
                ...
                <p>The logging requires logging configuration in the <code>&lt;botDetect&gt;</code> element and <code>BotDetectTroubleshootingModule</code> registration in the <code>web.config</code> file, as well as the <code>log4net.config</code> file defining log4net settings (in this case, logging to simple text files).</p>
