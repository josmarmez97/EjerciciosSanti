<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Default.aspx.vb" Inherits="CaptchaRequestDynamicSettingsExampleVBNet._Default" %>
...
<body>
    <form runat="server" class="column" id="form1">
        ...
        <fieldset>
            ...
            <BotDetect:WebFormsCaptcha runat="server" ID="DynamicCaptcha" UserInputControlID="CaptchaCodeTextBox" />
