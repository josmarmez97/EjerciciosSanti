<%@ Page Title="Register" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="WebForms451CaptchaExampleCSharp.Account.Register" %>
    ...
    <div class="form-horizontal">
        ...
        <div class="col-md-6" id="notes">
            <div class="note">
                ...
                <p>Since the Register form uses ASP.NET Identity user management, the example shows how to include BotDetect CAPTCHA validation in new user data validation (see <code>Account\Register.aspx</code> and <code>Account\Register.aspx.cs</code> source code).</p>
        ...
        <div class="form-group">
            <div class="col-md-5" id="systeminfo">
                <p>Visual Studio 2013 / .NET 4.5.1 / C# example project.</p>
