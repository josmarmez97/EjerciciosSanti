<%@ Page Title="Manage" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Manage.aspx.vb" Inherits="WebForms451CaptchaExampleVBNet.Manage" %>
    ...
    <div class="row">
        ...
        <div class="col-md-6" id="notes">
            ...
            <div class="note">
                ...
                <p>Since the Manage Account form uses ASP.NET Identity user management, the example shows how to include BotDetect CAPTCHA validation in user managing data validation (see <code>Account\Manage.aspx</code> and <code>Account\Manage.aspx.vb</code> source code).</p>
