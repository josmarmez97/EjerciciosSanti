<%@ Page Title="Log in" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Login.aspx.vb" Inherits="WebForms451CaptchaExampleVBNet.Login" Async="true" %>
    ...
    <div class="row">
        ...
        <div class="col-md-6" id="notes">
            ...
            <div class="note">
                ...
                <p>Since the Login form uses ASP.NET Identity user management, the example shows how to include BotDetect CAPTCHA validation in user logging data validation (see <code>Account\Login.aspx</code> and <code>Account\Login.aspx.vb</code> source code).</p>
