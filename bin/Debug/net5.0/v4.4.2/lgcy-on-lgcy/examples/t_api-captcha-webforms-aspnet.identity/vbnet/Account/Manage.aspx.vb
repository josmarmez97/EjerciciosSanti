...
Partial Public Class Manage
    ...
    Protected Sub Page_Load() Handles Me.Load
        ...
        SetPasswordCaptcha.UserInputID = SetPasswordCaptchaCode.ClientID
        ChangePasswordCaptcha.UserInputID = ChangePasswordCaptchaCode.ClientID
    ...
    Protected Sub SetPasswordCaptchaValidator_ServerValidate(source As Object, args As ServerValidateEventArgs)
        ' validate the Captcha to check we're not dealing with a bot
        args.IsValid = SetPasswordCaptcha.Validate(args.Value.Trim())

        SetPasswordCaptchaCode.Text = Nothing ' clear previous user input
    End Sub

    Protected Sub ChangePasswordCaptchaValidator_ServerValidate(source As Object, args As ServerValidateEventArgs)
        ' validate the Captcha to check we're not dealing with a bot
        args.IsValid = ChangePasswordCaptcha.Validate(args.Value.Trim())

        ChangePasswordCaptchaCode.Text = Nothing ' clear previous user input
    End Sub
End Class
